...
class AnimalMovement(Movement):
    def __init__(self, transform: Transform):
        ...
        self._rotation_action = RotationAction(transform)
    ...
    def _prepare_actions_list(self, target_direction: Direction) -> list[MotionAction]:
        target_rotation = find_shortest_rotation(self._transform.direction, target_direction)
        ...
        return [self._rotation_action, self._interpolation_action]
